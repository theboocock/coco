```{r, echo=T}
  ...
  afs  = apply(dat$bed,2,mean)/2
  afs[which(names(afs) %in% c("rs4417927","rs10520157"))]
  ...
  rownames(dat$bed)
 rownames(dat$bed) = str_replace(rownames(dat$bed),"0:","")
  ...
  coco_nek1 = res_preparation
  coco_nek1 <- structure(coco_nek1, class = "coco_data")
  save(coco_nek1,file="data/coco_nek1.RData")
  df = joint_from_ids(rsids = "rs10520157", res_preparation,joint=T)
