...
residuals(lm(residuals(lm(scale(dos_data$ENSG00000137601, scale = F) ~scale(dos_data$rs10520157,scale = F) )) ~ -1 + scale(dos_data$rs4417927,scale = F)))
### eq 4.
beta_hat = solve(diag(diag(XX))) %*% t(cbind(scale(dos_data$rs10520157,scale = F),scale(dos_data$rs4417927,scale = F))) %*% scale(dos_data$ENSG00000137601, scale=F)
...
sigma_c = (((t(scale(dos_data$ENSG00000137601,scale=F))%*%(scale(dos_data$ENSG00000137601, scale=F)) - t(beta_hat[1]) %*% XX[1,1] %*% beta_hat[1])- (t(beta_cond) %*% XX[2,2] %*% beta_cond)))/ 451
...
sigma_c = (((t(scale(dos_data$ENSG00000137601,scale=F))%*%(scale(dos_data$ENSG00000137601, scale=F)) - t(beta_hat[1]) %*% XX[1,1] %*% beta_hat[1]))- XX[2,2] %*% beta_cond^2) / (449)
beta_cond/sqrt(sigma_c / XX[2,2])
...
sigma_c = ((t(scale(dos_data$ENSG00000137601,scale=F)))%*%(scale(dos_data$ENSG00000137601, scale=F)) - t(beta_hat[1]) %*% XX[1,1] %*% beta_hat[1])/ 452 - (t(beta_cond) %*% XX[2,2] %*% beta / 452)
sqrt(sigma_c)
0.1097425
